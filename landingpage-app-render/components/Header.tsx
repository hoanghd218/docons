            ...
            <div className="max-w-7xl mx-auto">
                <div className="glass-liquid rounded-2xl shadow-xl shadow-primary/5 px-4 md:px-6 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        >
                            <div className="relative w-11 h-11 md:w-9 md:h-9 rounded-xl bg-gradient-to-br from-primary to-primary-hover p-0.5 group-hover:scale-110 group-hover:rotate-2 transition-all duration-300 cursor-pointer">
                                <div className="w-full h-full rounded-xl bg-white flex items-center justify-center">
                                    <Image
                                        src={brandConfig.branding.logo}
                                        alt={brandConfig.branding.logoAlt}
                                        fill
                            ...
                            <div className="hidden sm:block">
                                <h1 className="text-lg font-bold text-slate-900 tracking-tight font-display">
                                    <span className="text-primary">{brandConfig.company.shortName}</span>
                                </h1>
                            </div>
                        </Link>
